// Cache local application files for a lightweight offline PWA shell.
const CACHE_NAME = 'birds-of-paradise-v1';
const ASSETS = ['./', './index.html', './catalog.html', './logo.png', './manifest.webmanifest'];
